...
*이전 글: [A-5](<2026-04-28-A-5-위험을 재는 저울(feat. A 시리즈를 마치며).md>) 위험을 재는 저울 — NLF가 작동하는 숨은 엔진

*다음 글: [B-2](<2026-04-28-B-2-고위험 AI란 무엇인가.md>) '고위험 AI'란 무엇인가: 리스크 평가의 논리*
...
NLF는 "어떻게 만들라"가 아니라 "무엇을 달성하라"만 법에 썼다([A-1](<2026-04-05-A-1-why-europe-law-has-no-spec.md>)). 
...
NLF에서 CEN/CENELEC이 조화표준을 만들었듯([A-1](<2026-04-05-A-1-why-europe-law-has-no-spec.md>), [A-5](<2026-04-28-A-5-위험을 재는 저울(feat. A 시리즈를 마치며).md>)), AI Act도 같은 방식을 쓴다. 
...
위험의 크기에 따라 규제 강도가 달라지는 원리([A-5](<2026-04-28-A-5-위험을 재는 저울(feat. A 시리즈를 마치며).md>)). 
...
[A-4-1(Blue Guide)](<2026-04-28-A-4-1-Blue Guide는 해설서인가 설계도인가.md>)에서 확인한 제조사·수입업자·유통업자 의무 체계. 
...
NLF에서 사후 관리는 주로 시장감시기관(MSA)의 몫이었다([A-4](<2026-04-06-A-4-제품이 팔린 뒤가 더 무섭다.md>)). 
