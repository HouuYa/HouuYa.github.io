...
permalink: /b-4-ai-office는-왜-별도로-만들었나-feat-b-시리즈를-마치며/
categories:
  - EU-AI-Act
  - NLF
  - AI Regulation
...
독일 제품은 독일 MSA가 감시한다. 프랑스 제품은 프랑스 MSA가 감시한다. A-4에서 우리가 확인한 체계다. 

Regulation 2019/1020이 이들의 권한과 절차를 규정하고, Safety Gate(RAPEX)가 위험 정보를 공유하고, UPCN이 조정한다.
...
**2026년 개정(Digital Omnibus, Regulation (EU) 2026/1744)은 이 관할을 한 단계 더 넓혔다.** AI Office는 이제 GPAI 모델 자체뿐 아니라, 같은 사업자(undertaking)가 만든 GPAI 모델 위에 얹은 AI 시스템까지 전속 관할한다. 초대형 온라인 플랫폼·검색엔진(DSA상 VLOP·VLOSE)에 내장되거나 이를 구성하는 AI도 마찬가지다. 조사권·현장검사권·과징금 부과권까지 시장감시청 권한을 그대로 넘겨받은 신설 조문(Art.75a-75d)이 그 실행 장치다.[^9]
...
**우리나라와 비교하면 흥미로운 대칭이 나타난다.** 우리나라는 과기정통부 한 곳이 AI를 총괄한다. EU의 분산 모델과 정반대다. 우리나라의 인공지능안전연구소(법 제12조)는 AI Office의 한국판이라 할 수 있지만, 법적 근거와 권한 범위가 다르다. AI Office는 GPAI 집행권을 갖지만, 인공지능안전연구소는 "연구·평가" 중심이고 집행권은 명시되지 않았다.[^8]

더 근본적인 차이가 있다. EU는 AI Office를 **기존 NLF-MSA 체계 위에** 올렸다. 기초가 있는 건물에 새 층을 추가한 것이다. 우리나라는 기초(제품안전 시장감시 체계)와 새 층(AI 기본법)이 **서로 연결되지 않은 채** 병렬로 서 있다. 제품안전기본법과 AI 기본법 사이에 Reg 2019/1020 같은 연결 규범이 없다.

EU의 AI 거버넌스가 더 복잡해 보이지만, 복잡함의 이유가 있다. **40년간 쌓아온 체계 위에서의 복잡함**이기 때문이다. 우리나라의 단순함은 효율적일 수 있지만, 체계가 아니라 **빈칸**일 수도 있다.
...
C 시리즈에서 우리는 시선을 우리나라로 돌린다.

EU의 이 체계를 우리나라와 나란히 놓으면 무엇이 보이는가. 같은 목표를 향해 다른 길을 걷는 두 체계. 어느 쪽이 더 "똑똑한" 규제인가. 그 질문은 C-1에서 시작한다.
