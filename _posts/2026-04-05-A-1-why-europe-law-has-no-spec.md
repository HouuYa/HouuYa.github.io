...
두 글자 뒤에 무엇이 있는지 생각해 본 적이 있는가.  
거기에는 40년에 걸친 하나의 질문이 압축되어 있다.  
...
당시는 더 심했다.  
EU 집행위원회가 관보에 공고(Commission Notice) 형식으로 게재한 공식 해설서, 블루 가이드(Blue Guide, 2022)는 이 시절을 솔직하게 묘사한다.  
법령은 아니다. 구속력도 없다. 그런데도 EU 제품규제를 다루는 사람이 가장 자주 펼치는 문서다 — 이 문서의 정체는 [A-4-1](/a-4-1-blue-guide는-해설서인가-설계도인가-as/)에서 따로 다룬다. 
