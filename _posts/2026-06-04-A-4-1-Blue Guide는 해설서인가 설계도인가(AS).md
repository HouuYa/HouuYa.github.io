...
tags:
  ...
  - CE마킹
  - 규제설계
last_modified_at: 2026-06-04T15:00:00+09:00
---



# [A-4-1]({% post_url 2026-04-28-A-4-1-Blue Guide는 해설서인가 설계도인가 %}) Blue Guide는 해설서인가, 설계도인가 (update 2026-06-04)
...
Blue Guide는 **법령은 아니지만 EU 제품규제라는 도시의 공식 "지도"**다. 

법적 구속력은 없으나, 이 지도 없이는 NLF 체계 안에서 길을 찾을 수 없다.
...
- **비유**: 헌법–법률–시행령–시행규칙 어디에도 속하지 않으나, *실무자가 매일 펼치는 문서는 법전이 아니라 Blue Guide*.
  - 한국 법제처 "법령해석 사례집"과 비슷하되, 개별 질의응답이 아니라 **체계 전체를 하나의 서사로 설명**한다는 점에서 다름.

---

## 3. 9개 챕터 구성과 A 시리즈 대응

| 장 | 주제 | A 시리즈 원전 |
|----|------|--------------|
| 1 | 역사와 체계 (Old Approach→NLF), 세 법령·GPSD·제조물책임 | A-1, A-1-1 |
| 2 | 적용범위: "제품"·"시장출시" 정의, 온라인·역외 제조사 | — |
| 3 | 경제 주체(제조사·수입자·유통업자·수권대리인) 의무 | — |
| 4 | 제품요건: 필수요구사항·조화표준·기술문서·**EU DoC**·CE | — |
| 5 | 적합성평가: 모듈 A~H, NB 역할·통보·NANDO | A-2, A-3, A-3-1 |
| 6 | 인정(Accreditation): 국가인정기구·EA·동료평가 | A-3-1 |
| 7 | 시장감시: Reg 2019/1020, MSA 권한, RAPEX/Safety Gate | A-4 |
| 8 | EU 역외 제품: 수입검역, 세관–MSA 협력 | — |
| 9 | 국제무대: MRA, 국제표준화 | — |
...
## 6. update 메모 (2026-06-04)

- **최신판 재확인**: 검색 결과 Blue Guide는 2000년 초판 → 2014 → 2016 → **2022(OJ C 247)**가 현행 최신판으로 확인됨. 이후 정식 개정판 없음. 위키 근거자료가 최신과 일치.
- **원문 주석 [검토 필요] 항목**: "AI Act 시행에 맞춰 집행위가 Blue Guide를 업데이트할 가능성"은 2026-06 기준 별도 개정판 미발행 상태. 향후 모니터링 대상.
