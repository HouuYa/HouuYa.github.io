...
# [A-4-1](/a-4-1-blue-guide는-해설서인가-설계도인가/) Blue Guide는 해설서인가, 설계도인가 (update 2026-08-03)
...
- **비유**: 헌법–법률–시행령–시행규칙 어디에도 속하지 않으나, *실무자가 매일 펼치는 문서는 법전이 아니라 Blue Guide*. 우리나라 법제처 "법령해석 사례집"과 비슷하되, 개별 질의응답이 아니라 **체계 전체를 하나의 서사로 설명**한다는 점에서 다름.
...
- 우리나라 대비: 전기생활용품안전법·제품안전기본법·각종 고시는 있으나, **체계 전체의 설계논리를 하나의 서사로 설명하는 공식 문서**는 찾기 어려움.
...
### 2026-08-03 — 지도가 없는 구역

2026-08-03 기준으로도 개정판은 나오지 않았다. 현행판은 여전히 2022년 6월판이다.  
그런데 이 사실에는 위 §5의 논지에 단서를 다는 함의가 있다.

AI Act는 NLF 개념을 **정의 없이 그대로 끌어다 쓴다.** 기술문서(Art.11), Notified Body(Art.33), 적합성 평가 절차(Art.43), 시장감시(Art.74) — 어느 것도 AI Act 본문에서 처음부터 설명되지 않는다. 그 개념들을 해설하는 공식 문서는 Blue Guide뿐인데, Blue Guide 2022는 AI Act(2024)보다 2년 먼저 쓰였다.

정리하면 이렇다.

1. AI Act를 읽으려면 NLF 개념을 알아야 함.

2. NLF 개념의 공식 해설서는 Blue Guide 2022뿐임.

3. 그 Blue Guide에는 AI Act가 한 줄도 나오지 않음.

§5에서 EU의 "자기 설명 능력"을 짚었다. 제품안전 영역에서는 40년치 축적이 그 능력을 뒷받침한다. 다만 AI Act 영역에서는 그 능력이 아직 작동하지 않았다고 보는 편이 정확하다.

Digital Omnibus(Omnibus VII)로 Annex III형 고위험 AI 의무 적용이 2027-12-02로 연기되면서 이 공백을 메울 시간은 벌렸다.[^3] 시간이 늘어난 것이지, 공백이 사라진 것은 아니다.  
집행위의 Blue Guide 개정 여부는 계속 모니터링 대상으로 둔다.
